...
class Scraper:
    ...
    #needs a re-do
    def get_links(self, *, url='http://ciudadseva.com/autor/jorge-luis-borges/cuentos/', html_tag='div', html_class='text-justify'):
        ...
        raw_text = self.driver.find_elements_by_xpath('//'+html_tag+'[@class="'+html_class+'"]')
        #content = raw_text[0].text
        return raw_text

    def get_text(self, *, url='https://ciudadseva.com/texto/abel-y-cain-borges/', html_tag='div', html_class='text-justify'):
        self.driver.get(url)
        raw_text = self.driver.find_elements_by_xpath('//'+html_tag+'[@class="'+html_class+'"]')
        content = raw_text[0].text
